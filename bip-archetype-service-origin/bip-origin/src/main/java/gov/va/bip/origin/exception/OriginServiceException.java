 ...
 * @author aburkholder
 */
public class OriginServiceException extends BipRuntimeException {
	 ...
	 */
	public OriginServiceException(final MessageKey key, final MessageSeverity severity, final HttpStatus status,
			final String... params) {
