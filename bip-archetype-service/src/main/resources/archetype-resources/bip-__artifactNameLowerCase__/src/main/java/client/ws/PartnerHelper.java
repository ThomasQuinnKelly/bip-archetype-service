...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package gov.va.bip.${artifactNameLowerCase}.client.ws;
...
import gov.va.bip.${artifactNameLowerCase}.transform.impl.SampleByPid_DomainToPartner;
import gov.va.bip.${artifactNameLowerCase}.transform.impl.SampleByPid_PartnerToDomain;
...
//			// any other exception can be caught and thrown as ${artifactName}ServiceException for the circuit not to be opened
//			String message = THROWSTR + clientException.getClass().getName() + ": " + clientException.getMessage();
//			LOGGER.error(message, clientException);
//			throw new ${artifactName}ServiceException(clientException.getMessageKey(), clientException.getSeverity(),
