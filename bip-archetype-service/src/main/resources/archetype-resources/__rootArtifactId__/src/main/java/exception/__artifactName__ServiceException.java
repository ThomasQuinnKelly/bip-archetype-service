 ...
 * @author aburkholder
 */
public class ${artifactName}ServiceException extends BipRuntimeException {
	 ...
	 *
	 * @see BipRuntimeException${symbol_pound}BipRuntimeException(String, String, MessageSeverity, HttpStatus)
	 *
	 ...
	 */
	public ${artifactName}ServiceException(final MessageKey key, final MessageSeverity severity, final HttpStatus status,
			final String... params) {
	 ...
	 *
	 * @see RuntimeException${symbol_pound}RuntimeException(String, Throwable)
	 *
	 * @param key - the consumer-facing key that can uniquely identify the nature of the exception
	 * @param severity - the severity of the event: FATAL (500 series), ERROR (400 series), WARN (200 series), or INFO/DEBUG/TRACE
	 * @param status - the HTTP Status code that applies best to the encountered problem, see
