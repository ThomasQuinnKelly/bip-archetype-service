...
import gov.va.bip.${artifactNameLowerCase}.api.${artifactName}Api;
 ...
 */
@RestController
public class ${artifactName}Resource implements ${artifactName}Api, HealthIndicator, SwaggerResponseMessages {

	/** Logger instance */
	private static final BipLogger LOGGER = BipLoggerFactory.getLogger(${artifactName}Resource.class);

	/** The root path to this resource */
	public static final String URL_PREFIX = "/api/v1/${artifactNameLowerCase}";
	 ...
	 *
	 * @see org.springframework.boot.actuate.health.HealthIndicator${symbol_pound}health()
	 */
	@Override
	...
	public Health health() {
		return Health.up().withDetail("${artifactName} Service REST Endpoint", "${artifactName} Service REST Provider Up and Running!")
				.build();
	}
