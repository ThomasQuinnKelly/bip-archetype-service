...
import gov.va.bip.${artifactNameLowerCase}.api.model.v1.SampleInfo;
 ...
 * @author aburkholder
 */
public class SampleByPid_DomainToProvider extends AbstractDomainToProvider<SampleDomainResponse, SampleResponse> {
