...
public class SampleInfo {
	...
	@When("^client request info ${symbol_escape}"([^${symbol_escape}"]*)${symbol_escape}" with PID data ${symbol_escape}"([^${symbol_escape}"]*)${symbol_escape}"${symbol_dollar}")
	...
	@And("^the ${artifactName} service returns ParticipantID PID based on participantId (${symbol_escape}${symbol_escape}d+)${symbol_dollar}")
	...
	@And("^the service returns message ${symbol_escape}"([^${symbol_escape}"]*)${symbol_escape}" and ${symbol_escape}"([^${symbol_escape}"]*)${symbol_escape}"${symbol_dollar}")
	...
	@And("^the service returns message ${symbol_escape}"([^${symbol_escape}"]*)${symbol_escape}"${symbol_dollar}")
