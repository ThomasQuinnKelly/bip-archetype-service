...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package gov.va.bip.${artifactNameLowerCase}.service.runner;
...
@CucumberOptions(strict = false, plugin = { "pretty",
		...
		features = { "src/inttest/resources/gov/va/${artifactNameLowerCase}/feature" },
		glue = { "gov.va.bip.${artifactNameLowerCase}.service.steps" })
